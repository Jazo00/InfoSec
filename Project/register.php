        ...
        ?>
            ...
            <form action="" method="post" id="registrationForm">
                <div class="form-group"> 
                    ...
                    <div id="studentNumberError" style="color: red;"></div>
                </div>   
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="password" name="password" id="password" autocomplete="off" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}">
                </div>
                <div class="form-group">
        ...
        <script>
            document.getElementById('registrationForm').addEventListener('submit', function(event) {
                ...
                if (!studentNumberRegex.test(studentNumberInput)) {
                    ...
                    document.getElementById('studentNumberError').textContent = ''; // Clear error message if validation successful
                }
            });
        </script>
